...
library(pacman)
p_load(tidyverse, httr, lubridate, janitor, jsonlite, listviewer, usethis, rvest, data.table, xml2, readxl, here, dplyr, plotly, lubridate, naniar, readr)
```
...
```{r}
reg1 <- lm(co2_total_greenhouse_equiv ~ hydro_electric_perc + pop, data = hydro_data_subset)
summary(reg1)
```
