...
### The p-value from our regression is not significant at the at the %% level, which means that we fail to reject our null hypothesis, in other words we fail to conclude that hydroelectric energy percantage has a significant impact on percapita greenhouse gas emissions. Our evidence - World Bank Data data from 2005-2008 and in countries that are middle-income or higher and have access to clean drinking water - does not indicate that hydroelecric energy has a significant impact on  percapita greenhouse gas emissions.
